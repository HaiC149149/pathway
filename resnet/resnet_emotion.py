...
def main():
    ...
    train_dataloader = getDataLoader(train_data_df, 'Emotion', trans_train,
                                     'train', args.batch_size)
    test_data_df = pd.read_pickle(args.test_path)
    test_dataloader = getDataLoader(test_data_df, 'Emotion', trans_test,
    ...
    # net.fc = nn.Sequential(nn.Linear(in_channel, 512), nn.ReLU(),
